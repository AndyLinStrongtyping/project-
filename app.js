...
time_line.fromTo( slider , 1 ,{x: "-100%" },{x: "0%" , ease: Power2.easeInOut  } , "-=1.2s" );
...
function setGPA(){
   ...
   for (let i = 0; i < formLength; i++) {
      if (credits[i] && !isNaN(credits[i].valueAsNumber)) {
...
newDive.appendChild(newInput2);
newDive.appendChild(newInput3);
newDive.appendChild(newSelect);
newDive.appendChild(newButton);
